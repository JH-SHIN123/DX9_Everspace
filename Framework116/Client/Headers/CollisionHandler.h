...
public:
	...
	static void Collision_SphereToSphere_Damage(const wstring& wstrDstLayerTag, const wstring& wstrSrcLayerTag);
	static void	Collision_PlayerToBoss(const wstring& wstrDstLayerTag, const wstring& wstrSrcLayerTag);
	static _bool Collision_PlayerToObject(const wstring& wstrDstLayerTag, const wstring& wstrSrcLayerTag);
	static void	Collision_PlayerToEMPBomb(const wstring& wstrDstLayerTag, const wstring& wstrSrcLayerTag);
