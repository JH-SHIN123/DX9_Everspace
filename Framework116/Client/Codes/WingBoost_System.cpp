...
CWingBoost_System::CWingBoost_System(LPDIRECT3DDEVICE9 pDevice)
	: CParticleSystem(pDevice)
{
}

CWingBoost_System::CWingBoost_System(const CWingBoost_System& other)
	: CParticleSystem(other)
{
}

void CWingBoost_System::ResetParticle_ParticleSystem(PARTICLE_ATTRIBUTE& attribute)
{
	if (nullptr == m_pTransform) return;

	attribute.isAlive = true;
	attribute.vPos = m_vWingOffset;
...
HRESULT CWingBoost_System::Ready_GameObject_Prototype()
{
...
HRESULT CWingBoost_System::Ready_GameObject(void* pArg)
{
...
_uint CWingBoost_System::Update_GameObject(_float fDeltaTime)
{
...
_uint CWingBoost_System::LateUpdate_GameObject(_float fDeltaTime)
{
	...
	if (false == (IsEmpty_ParticleSystem() || IsDead_ParticleSystem())) {
...
_uint CWingBoost_System::Render_GameObject()
{
...
CWingBoost_System* CWingBoost_System::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CWingBoost_System* pInstance = new CWingBoost_System(pDevice);
...
CGameObject* CWingBoost_System::Clone(void* pArg)
{
	CWingBoost_System* pClone = new CWingBoost_System(*this); /* 복사 생성자 호출 */
